package com.tecknobit.binancemanager.managers.signedmanagers.websocketmanagers.marketstreams;
 ...
 **/
public class BinanceMarketStreamsManager extends BinanceWebsocketManager {
     ...
     **/
    public BinanceMarketStreamsManager(String baseEndpoint, String defaultErrorMessage, int timeout, String apiKey,
     ...
     * @param secretKey           your secret key
     **/
    public BinanceMarketStreamsManager(String baseEndpoint, String defaultErrorMessage, String apiKey,
                                       String secretKey) throws SystemException, IOException {
     ...
     * @param secretKey    your secret key
     **/
    public BinanceMarketStreamsManager(String baseEndpoint, int timeout, String apiKey,
                                       String secretKey) throws SystemException, IOException {
     ...
     * @param secretKey    your secret key
     **/
    public BinanceMarketStreamsManager(String baseEndpoint, String apiKey,
                                       String secretKey) throws SystemException, IOException {
